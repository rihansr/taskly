...
import 'domain/usecases/single_section_usecase.dart' as _i599;
import 'domain/usecases/update_section_usecase.dart' as _i433;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.lazySingleton<_i142.SectionsRepository>(
        () => _i8.SectionsRepositoryImpl(gh<_i729.SectionsApiImpl>()));
    gh.lazySingleton<_i702.DeleteSectionUseCase>(
        () => _i702.DeleteSectionUseCase(gh<_i142.SectionsRepository>()));
    gh.lazySingleton<_i433.UpdateSectionUseCase>(
        () => _i433.UpdateSectionUseCase(gh<_i142.SectionsRepository>()));
    gh.lazySingleton<_i963.CreateSectionUseCase>(
        () => _i963.CreateSectionUseCase(gh<_i142.SectionsRepository>()));
    gh.lazySingleton<_i599.SingleSectionUseCase>(
        () => _i599.SingleSectionUseCase(gh<_i142.SectionsRepository>()));
